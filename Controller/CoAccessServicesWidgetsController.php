...
class CoAccessServicesWidgetsController extends SDWController {
  // Class name, used by Cake
  public $name = "CoAccessServicesWidgets";
  
  public $uses = array("AccessServicesWidget.CoAccessServicesWidget", "CoService");
  ...
  public function display($id) {
    ...
    $coServices = $this->CoAccessServicesWidget->CoDashboardWidget->CoDashboard->Co->CoService->find('all', $args);
